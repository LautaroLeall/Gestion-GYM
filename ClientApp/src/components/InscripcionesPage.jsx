 ...
 * inscripciones seleccionando un socio y una clase de las listas.  También
 * se listan las inscripciones existentes con opción para eliminarlas.
 * Esta página reemplaza a la antigua página de reservas.
 */
  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="bg-white shadow-md rounded p-4 space-y-4">
        <h3 className="text-lg font-medium">Nueva inscripción</h3>
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead>
            <tr>
              ...
              <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Fecha inscripción</th>
